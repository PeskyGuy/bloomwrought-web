                            ...
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    `px-4 py-2 rounded-lg transition-all duration-200 font-medium ${isActive
                                        ? 'bg-verdant-100 dark:bg-verdant-900 text-verdant-900 dark:text-verdant-100 shadow-sm translate-x-1'
                                        : 'text-zinc-600 dark:text-zinc-400 hover:bg-verdant-50 dark:hover:bg-verdant-900/50 hover:text-verdant-700 dark:hover:text-verdant-300'
                                    }`
                                }
                            >
                                {link.label}
